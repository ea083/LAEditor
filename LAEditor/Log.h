        ...
        if (ImGui::BeginChild("ScrollingRegion", ImVec2(0, -footer_height_to_reserve), false, ImGuiWindowFlags_HorizontalScrollbar))
        {
            ...
            for (int i = 0; i < Items.Size; i++)
            {
                ...
                if (strstr(item, "[error]")) { 
                    ...
                    color = ImVec4(1.0f, 0.56f, 0.0f, 1.0f);
                    has_color = true;
                }
...
public:
    ...
    template<typename... Args>
    inline void logConsoleError(format_string_t<Args...> fmt, Args &&...args) {
        std::string formattedMessage = fmt::format(fmt, std::forward<Args>(args)...);
    ...
    template<typename... Args>
    inline void logConsoleWarning(format_string_t<Args...> fmt, Args &&...args) {
        std::string formattedMessage = fmt::format(fmt, std::forward<Args>(args)...);
...
// Core log macros
#define LAE_CORE_TRACE(...) ::Log::GetCoreLogger()->trace(__VA_ARGS__)
#define LAE_CORE_INFO(...)  ::Log::GetCoreLogger()->info(__VA_ARGS__)
#define LAE_CORE_WARN(...)  ::Log::GetCoreLogger()->warn(__VA_ARGS__)
#define LAE_CORE_ERROR(...) ::Log::GetCoreLogger()->error(__VA_ARGS__)
#define LAE_CORE_FATAL(...) ::Log::GetCoreLogger()->fatal(__VA_ARGS__)

// Client log macros
#define LAE_TRACE(...) ::Log::logConsole(__VA_ARGS__);          ::Log::GetClientLogger()->trace(__VA_ARGS__)
#define LAE_INFO(...)  ::Log::logConsole(__VA_ARGS__);          ::Log::GetClientLogger()->info(__VA_ARGS__)
#define LAE_WARN(...)  ::Log::logConsoleWarning(__VA_ARGS__);   ::Log::GetClientLogger()->warn(__VA_ARGS__)
#define LAE_ERROR(...) ::Log::logConsoleError(__VA_ARGS__);     ::Log::GetClientLogger()->error(__VA_ARGS__)
#define LAE_FATAL(...) ::Log::logConsole(__VA_ARGS__);          ::Log::GetClientLogger()->fatal(__VA_ARGS__)

...
public:
	...
	Shader(const char* vertexPath, const char* fragmentPath, const char* geometryPath = nullptr) {
		...
		try {
			...
			// if geo shader is present, also load it
		...
		const char* vShaderCode = vertexCode.c_str(); // convert string to array of chars
	...
	// const functions cannot change a member variable of this class
